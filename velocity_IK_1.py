...
class scara:
    def __init__(self,l1,l2,v,damping):
        ...
        self.theta_2_i = 0 #initial elbow angle
        self.theta_1 = 0 #shoulder angle
        self.theta_2 = 0 #elbow angle
        self.x_g = 0 #x-coordinate of goal
    ...
    def main_func(self):
        ...
        if self.l1 - self.l2 <= np.linalg.norm(g)<=self.l1 + self.l2:
